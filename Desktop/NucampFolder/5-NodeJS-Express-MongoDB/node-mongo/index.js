...
MongoClient.connect(url, { useUnifiedTopology: true }, (err, client) => {
    ...
    db.dropCollection('campsites', (err, result) => {
      ...
      // replacing this line with the dboper = const collection = db.collection('campsites'); 

        dboper.insertDocument(db, {name: "Breadcrumb Trail Campground", description: "Test"},
            // currently doesnt run, a callback function awaiting for someone to call it. (Waiting for result)
        'campsites', result => {
